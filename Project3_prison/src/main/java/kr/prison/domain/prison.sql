...
CREATE TABLE IF NOT EXISTS `koko`.`PATROL_HISTORY` (
  ...
  `PH_DATE` DATE NULL,
  `PH_TIME_START` TIME NULL,
  `PH_TIME_END` TIME NULL,
  `LOCATION` VARCHAR(45) NULL,
  `CONTENTS` VARCHAR(45) NULL,
  `PRISON_OFFICER_PO_NO1` VARCHAR(45) NOT NULL,
  `PRISON_OFFICER_PO_NO2` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`PH_NO`),
  INDEX `fk_PATROL_HISTORY_PRISON_OFFICER1_idx` (`PRISON_OFFICER_PO_NO1` ASC),
  INDEX `fk_PATROL_HISTORY_PRISON_OFFICER2_idx` (`PRISON_OFFICER_PO_NO2` ASC),
  CONSTRAINT `fk_PATROL_HISTORY_PRISON_OFFICER1`
    FOREIGN KEY (`PRISON_OFFICER_PO_NO1`)
    REFERENCES `koko`.`PRISON_OFFICER` (`PO_NO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PATROL_HISTORY_PRISON_OFFICER2`
    FOREIGN KEY (`PRISON_OFFICER_PO_NO2`)
    REFERENCES `koko`.`PRISON_OFFICER` (`PO_NO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `koko`.`SPEC_DRUG_HISTORY` (
  ...
  INDEX `fk_SPEC_DRUG_HISTORY_PRISONER1_idx` (`PRISONER_PRISON_NUMBER` ASC),
  CONSTRAINT `fk_SPEC_DRUG_HISTORY_DRUG_MANAGEMENT_HISTORY1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SPEC_DRUG_HISTORY_PRISONER1`
    FOREIGN KEY (`PRISONER_PRISON_NUMBER`)
    REFERENCES `koko`.`PRISONER` (`PRISON_NUMBER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
