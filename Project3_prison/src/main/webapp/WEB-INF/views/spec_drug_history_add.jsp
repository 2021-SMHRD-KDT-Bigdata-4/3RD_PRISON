...
<title>코도소 3차 프로젝트 | 특별 약물 내역 추가</title>
		...
		<form method="post" action="${cpath}/spec_drug_history_insert.do">
			<div class="form">
				<div class="input_field">
					<label>약물 관리 번호</label> <input type="text"
						id="drug_management_history_dm_no" class="input"
						name="drug_management_history_dm_no">
				</div>
				<div class="input_field">
